...
export const INITIAL_FOODS: Omit<FoodItem, "history">[] = [
  {
    id: "viva-nuts-01", name: "無調味綜合果", brand: "萬歲牌",
    barcode: "4710022026362", category: "堅果種子",
    image: "",
    servingSizeText: "本包裝含28份，每份28公克",
    servingValue: 28,
    isLiquid: false,
    perServing: { energy: 181, protein: 4.8, fat: 15.6, saturatedFat: 1.8, transFat: 0, cholesterol: 0, carbohydrate: 5.4, sugar: 1.1, 
                 fiber: 2.2, sodium: 1, calcium: 32, potassium: 188, phosphorus: 120, magnesium: 51, zinc: 0.9, iron: 1.2 },
    per100g: { energy: 646, protein: 17.1, fat: 55.7, saturatedFat: 6.4, transFat: 0, cholesterol: 0, carbohydrate: 19.3, sugar: 3.9, 
              fiber: 7.9, sodium: 4, calcium: 114, potassium: 671, phosphorus: 429, magnesium: 182, zinc: 3.2, iron: 4.3 }
  },
  {
    id: "imei-milk-01", name: "低脂鮮乳", brand: "義美",
    barcode: "4712439121088", category: "乳製品",
    image: "",
    servingSizeText: "本包裝含1份，每份290毫升",
    servingValue: 290,
    isLiquid: true,
    perServing: { energy: 131, protein: 9.3, fat: 4.4, saturatedFat: 2.9, transFat: 0, cholesterol: 15, carbohydrate: 13.9, sugar: 13.9, 
                 fiber: 0, sodium: 122, calcium: 319, potassium: 435, phosphorus: 250, magnesium: 29, zinc: 1.1, iron: 0.1  },
    per100g: { energy: 45, protein: 3.2, fat: 1.5, saturatedFat: 1.0, transFat: 0, cholesterol: 5.2, carbohydrate: 4.8, sugar: 4.8, 
              fiber: 0, sodium: 42,
      calcium: 110,
      potassium: 150,
      phosphorus: 86,
